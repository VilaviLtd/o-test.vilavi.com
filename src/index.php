         ...
         <div class="stages__container">
             <div class="stage__other-countries" data-type="card" data-side="front">
                 ...
                 <div class="stage-country__info-block">
                     ...
                     <div class="info-block-text">
                          Оформите заказ из России на тест для определения уровня Омега-3. Чтобы получить бесплатную доставку, добавьте в корзину либо Сертификат О! TEST, либо 2 сертификата О! TEST и подарок. Бесплатная доставка распространяется только на эти позиции.
                     </div>
                 </div>
             </div>
             <div class="stage__other-countries" data-type="card" data-side="front">
             ...
             <div class="stage__other-countries" data-type="card" data-side="front">
                 ...
                 <div class="stage-country__info-block">
                     ...
                     <div class="info-block-text">
                         Ожидайте результат на ваш Email.
                     </div>
                 </div>
             </div>
             <div class="stage__other-countries" data-type="card" data-side="front">
             ...
             <div class="stage__other-countries" data-type="card" data-side="front">
                 ...
                 <div class="stage-country__info-block">
                     ...
                     <div class="info-block-text">
                          Принимайте продукты, рекомендованные в протоколе коррекции.
                     </div>
                 </div>
             </div>
             <div class="stage__other-countries" data-type="card" data-side="front">
